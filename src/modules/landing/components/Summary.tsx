    ...
    <div>
      ...
      <div className="max-w-[70ch] box-content space-y-6 border-3 p-6 font-mono lowercase backdrop-blur-xs">
        ...
        <p>
          ...
          as a{' '}
          <span className="text-[22px] text-glow-sm text-shadow-primary font-lowres">
            Senior Full-Stack web developer
          </span>
          ™  and <span className="text-[22px] text-glow-sm text-shadow-primary font-lowres">Team Lead</span> for the last 3 years. Check out
          my CV for details
        </p>
